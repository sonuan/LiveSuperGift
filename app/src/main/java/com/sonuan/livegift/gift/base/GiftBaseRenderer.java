...
import com.sonuan.livegift.gift.MyInterploator;

public abstract class GiftBaseRenderer {
    ...
    public GiftBaseRenderer(Context context) {
    ...
    private void setupAnimators() {
        ...
        mRenderAnimator.setInterpolator(new MyInterploator());
